...
% Last Modified by GUIDE v2.5 19-Jul-2018 13:43:41
...
% --- Executes when selected object is changed in moveSelect.
function moveSelect_SelectionChangedFcn(hObject, eventdata, handles)
% hObject    handle to the selected object in moveSelect 
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
